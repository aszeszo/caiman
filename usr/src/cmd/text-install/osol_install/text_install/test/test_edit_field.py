...
import osol_install.text_install.edit_field as edit_field
...
class TestEditField(TestEditFieldBase):
    ...
    def test_private_set_text_unmodified(self):
        '''Ensure that the private _set_text function does NOT flip the "modified" flag.'''
        self.assertFalse(self.edit._modified)
        self.edit._set_text("foo")
        self.assertFalse(self.edit._modified)
    
    def test_clear_text_modified(self):
        '''Ensure that clear_text() sets the modified flag, and clears the text'''
        self.assertFalse(self.edit._modified)
