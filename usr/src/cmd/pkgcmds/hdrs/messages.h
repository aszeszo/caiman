...
#define	ERR_CANNOT_REVERT		gettext("unable to convert SQL format package database to contents file: %s\nPlease run the command again with root user privileges")
...
#define	ERR_UNABLE_TO_INSPECT		gettext("unable to inspect SQL database %s/%s")
...
#define	MSG_REVERTING			gettext("Converting the SQL-format package database to a flat text contents file.")
