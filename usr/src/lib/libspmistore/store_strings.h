...
#define	MSG0_BOOT_PROM_CHANGING_x86		ILIBSTR(\
	"Changing the system's BIOS default boot device")
#define	MSG0_BOOT_PROM_CHANGING_SPARC		ILIBSTR(\
	"Changing the system's default boot device in the EEPROM")
#define	MSG0_BOOT_PROM_CHANGE_REQUIRED_x86	ILIBSTR(\
	"Change the system's BIOS default boot device for hands-off rebooting")
#define	MSG0_BOOT_PROM_CHANGE_REQUIRED_SPARC	ILIBSTR(\
	"Change the system's default boot device in the EEPROM for hands-off rebooting")
