...
TI_ATTR_ZFS_FS_PROPERTIES =  ti_defines['TI_ATTR_ZFS_FS_PROPERTIES'].strip('"')
TI_ATTR_ZFS_FS_PROP_NAMES =  ti_defines['TI_ATTR_ZFS_FS_PROP_NAMES'].strip('"')
TI_ATTR_ZFS_FS_PROP_VALUES =  ti_defines['TI_ATTR_ZFS_FS_PROP_VALUES'].strip('"')
