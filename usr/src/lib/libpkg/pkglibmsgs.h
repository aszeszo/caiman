...
#define	ERR_DB_OPEN "Cannot open the install database"
#define	ERR_CREATE_SQL_DB "Cannot create the install database"
#define	ERR_CREATE_TABLES_DB "Cannot create install database tables: %s"
