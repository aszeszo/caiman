...
extern ulong_t	get_blk_size_n __P((short n));
extern ulong_t	get_frag_size_n __P((short n));
extern ulong_t	get_blk_used_n __P((short n));
extern void	set_blk_used_n __P((short n, ulong_t value));
extern ulong_t	get_blk_free_n __P((short n));
extern ulong_t	get_inode_used_n __P((short n));
extern ulong_t	get_inode_free_n __P((short n));
...
extern int	ocfile __P((VFP_T **mapvfp, VFP_T **tmpvfp, ulong_t map_blks));
...
extern long	nblk __P((long size, ulong_t bsize, ulong_t frsize));
